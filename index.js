...
class ProjectManager extends Instructor{
  constructor({name, age, location, specialty, favLanguage, catchPhrase, favSubjects, gradClassName, favInstructor}){
    super(({name, age, location, specialty, favLanguage, catchPhrase, favSubjects, gradClassName, favInstructor}));
